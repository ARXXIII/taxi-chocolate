...
const List = ({ title, list, tel }: ListProps) => {
    return (
        <div className='flex flex-col gap-y-3 p-3 border-2 border-dark-chocolate rounded-xl shadow'>
            <h1 className='p-3 text-center font-bold text-xl lg:text-2xl text-taxi bg-dark-chocolate rounded-lg tracking-wide'>{title}</h1>
            <div className='grid grid-cols-1 gap-y-3 text-lg lg:text-xl'>
